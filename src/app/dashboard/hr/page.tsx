...
const MODULES: Tile[] = [
  {
    title: "Employee",
    description: "Staff directory, profiles & records",
    href: "/dashboard/hr/employee",
    Icon: User,
  },
  {
    title: "Payslip",
    description: "Salaries, payslips & payroll",
    href: "/dashboard/hr/payslip",
    Icon: Receipt,
  },
];
    ...
    <>
      ...
      <div className="animated-bg min-h-screen relative overflow-hidden">
        ...
        <header className="relative z-10 flex items-center justify-between px-6 md:px-10 py-5">
          <div
            className="flex items-center bg-white rounded-2xl px-6 py-3"
            style={{
              boxShadow:
                "0 12px 30px -8px rgba(0,0,0,0.35), 0 4px 10px rgba(0,0,0,0.15)",
            }}
          >
            <Image
              src="/logo.png"
          ...
          <Link
            href="/login"
            className="inline-flex items-center gap-2 rounded-full bg-white/10 hover:bg-white/20 text-white text-sm font-medium px-4 py-2 backdrop-blur-md border border-white/15 transition-colors"
          >
            <LogOut size={16} />
            Log out
          </Link>
