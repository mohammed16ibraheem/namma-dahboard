      ...
      <main className="flex-1 w-full px-4 md:px-8 py-8">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-800">Current Receivables</h1>
              <p className="text-sm text-gray-500">Add client entries and calculate total receivable amount</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden mb-5">
            ...
            <div className="px-5 py-3 border-b border-gray-100 bg-gray-50/60 flex items-center justify-between">
              ...
              <span className="text-xs text-gray-400">
                {rows.filter(r => r.clientName.trim() || num(r.amount) > 0).length} entr{rows.filter(r => r.clientName.trim() || num(r.amount) > 0).length === 1 ? "y" : "ies"}
              </span>
            </div>
