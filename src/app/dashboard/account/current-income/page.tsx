...
export default function CurrentIncomePage() {
  ...
  function handleSubmit() {
    ...
    if (filled.length === 0) {
      setError("Please add at least one bank entry.");
      return;
    }
    const incomplete = filled.find((r) => !r.bankName.trim() || num(r.amount) <= 0);
    if (incomplete) {
      setError("Each row needs a Bank Name and an Amount greater than 0.");
      return;
    }
      ...
      <div className="min-h-screen flex flex-col" style={{ backgroundColor: "#F4F6FA" }}>
        ...
        <div className="flex-1 flex items-center justify-center px-4">
          <div className="flex flex-col items-center gap-4 text-center max-w-md">
            ...
            <h2 className="text-2xl font-bold text-gray-800">Income Saved</h2>
                  ...
                  {rows.map((row, idx) => (
                    ...
                    >
                      ...
                      <td className="px-3 py-2.5">
                        <input
                          type="text"
                          placeholder="e.g. Arab National Bank"
                          value={row.bankName}
